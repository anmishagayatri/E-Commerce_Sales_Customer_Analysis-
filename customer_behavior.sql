...
Select count(customer_id) as customer_count ,subscription_status,avg(purchase_amount) as average_spend  , sum(purchase_amount) as total_revenue
from customer
...
end  as frequency , count(previous_purchases)
from customer
group by frequency
;
